 ...
 * inconsistências entre browsers e adicionar funcionalidades 
 * que não existiam nativamente. A padronização dos browsers e a 
...
/**
 * VERIFICAR SE EXISTE
 * O typeof retorna o tipo de dado. Caso 
 * esse dado não exista ou não tenha sido definido, 
 * ele irá retornar undefined. Ou seja, quando não for 
 ...
 * criada para a interação com outros softwares. Ou seja, toda interação 
 * que fazemos com o browser utilizando Objetos, Métodos e Propriedades, 
